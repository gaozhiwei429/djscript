...
class WxQrcodePayConfig
{
	 ...
	 * @var string
	 */
	const APPID = 'wx34080b3cb919ec91';//wxf5f0b8b58bc4346d
	const MCHID = '1497776632';//1495338032
	const KEY = 'c83211db31d7d0853e0f5f6180c3b305';//b69da2f1074c143a3cb8491eb278c846
	const APPSECRET = '69540b3cd2b221a9ed5d0eb5a9d579b3';//b0f7615e1573eaae3c329241c5864303
    const NOTIFY_URL = 'http://web.test.tingxihuan.cn/pay/pay/wx-pay-notify-call-back';//'http://api.wbaole.com/pay/pay/wx-pay-notify-call-back';
...
//    const NOTIFY_URL = 'http://web.tingxihuan.cn/pay/pay/wx-pay-notify-call-back';//'http://api.wbaole.com/pay/pay/wx-pay-notify-call-back';
	 ...
	 * @var path
	 */
	const SSLCERT_PATH = '../twocert/apiclient_cert.pem';
	const SSLKEY_PATH = '../twocert/apiclient_key.pem';
