<?php
/**
 *	$fileName Vcode.class.php	
 *	$date 2013-01-21 18:37
 *	$author silenceper
 *	$version 2.0
 *		2.0更新:支持中文验证码
 */
namespace source\libs\code;
use Yii;
class Vcode{
	//图片资源
	private $image=null;	
	 ...
	 *
	 */
	public function __construct($width=100,$height=30,$codeNum=5){
		//判断服务器环境是否安装了GD库
	...
	//显示验证码图片
	public function showImage($code, $fontFace='',$chinese=false){
...
//        $this->createCode();
	...
	//往图片上添加文本
	private function outputText($code, $fontFace=''){
        $this->code = $code;
