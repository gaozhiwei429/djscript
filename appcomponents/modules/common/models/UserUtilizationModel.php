...
class UserUtilizationModel extends BaseModel
{
...
//                return $query->createCommand()->getRawSql();
    ...
    public function addInfo($addData) {
        try {
            ...
            $thisModel->user_id = isset($addData['user_id']) ? intval($addData['user_id']) : 0;//用户id
            $thisModel->utilization_ids = isset($addData['utilization_ids']) ? trim($addData['utilization_ids']) : "";
            $thisModel->save();
