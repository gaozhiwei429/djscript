...
class DangHistoryModel extends BaseModel
{
...
//            $query->createCommand()->getRawSql();
            ...
            DmpLog::warning('getListData_dang_history_model_error', $e);
            return [];
        }
    }
    /**
...
//                return $query->createCommand()->getRawSql();
            ...
            DmpLog::warning('getCount_dang_history_model_error', $e);
            return 0;
        }
    }
    ...
    public function addInfo($addData) {
        try {
            ...
            $thisModel->month = isset($addData['month']) ? intval($addData['month']) : 0;
...
//            return $isSave;
            ...
            DmpLog::error('insert_dang_history_model_error', $e);
            return false;
        }
    }
