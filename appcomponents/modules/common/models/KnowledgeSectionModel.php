...
/**
 * 知识库学习内容章节数据模型
 * @文件名称: KnowledgeSectionModel.php
 * @author: jawei
...
class KnowledgeSectionModel extends BaseModel
{
...
//            $query->createCommand()->getRawSql();
            ...
            DmpLog::warning('getListData_knowledgeSectionModel_error', $e);
            return [];
        }
    }
    /**
...
//                return $query->createCommand()->getRawSql();
            ...
            DmpLog::warning('getCount_knowledgeSectionModel_error', $e);
            return 0;
        }
    }
}
