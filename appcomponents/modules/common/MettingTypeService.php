<?php
/**
 * 三会一课分类相关的数据获取service
 * @文件名称: MettingTypeService.php
 * @author: jawei
...
use appcomponents\modules\common\models\MettingTypeModel;
use source\libs\Common;
use source\manager\BaseException;
use source\manager\BaseService;
use Yii;
class MettingTypeService extends BaseService
{
    /**
     * @inheritdoc
     */
    ...
    public function getList($params = [], $orderBy = [], $p = 1, $limit = 10, $fied=['*'], $index=false) {
        ...
        $newsModel = new MettingTypeModel();
