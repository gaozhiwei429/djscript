...
use appcomponents\modules\common\CollectionService;
...
class CollectionController extends UserBaseController
{
    ...
    public function actionGetList() {
        ...
        $newsService = new CollectionService();
        $params = [];
    ...
    public function actionSubmit() {
        ...
        $feebackService = new CollectionService();
    ...
    public function actionCheck() {
        ...
        $zanParams[] = ['=', 'status', 1];
        $ret = $newsService->getInfo($zanParams);
